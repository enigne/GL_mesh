function [Edge_Node, Edges, Edge_Element, Boundary] = getEdges(elements)
...
for i = 1: nEle
    for n = 1:3
        ...
        Edges(i, n) = Edge_Node(((Edge_Node(:,1) == oneEdge(1)) & ...
            (Edge_Node(:,2) == oneEdge(2))), 3);
    end
    Edges(i, 4) = edges2element(i, 3);
end

% 3. A matrix Edge_Element of size 3xnrofedges: (el1; el2; edge)
